...
import NexPrintBlackColor from '@/shared/components/Icon/json/nexprint-black-color.json';
import IllustrationTeamSuccess from '@/shared/components/Icon/json/illustration-team-success.json';
...
export const IconsReference = {
  ...
  nexprint_black_color_full_fill: { type: 'data', value: NexPrintBlackColor },
  ...
  check_regular: { type: 'string', value: 'fe:check' },
  illustration_team_success: { type: 'data', value: IllustrationTeamSuccess },
